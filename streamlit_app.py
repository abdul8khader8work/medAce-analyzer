...
import matplotlib.pyplot as plt
import re
import openai  # ChatGPT Integration

# Set OpenAI API key (read from Streamlit secrets)
openai.api_key = st.secrets["OPENAI_API_KEY"]
                ...
                try:
                    response = openai.ChatCompletion.create(
                        ...
                        messages=[
                            {
                                "role": "system",
                                "content": "You are a helpful medical assistant. Explain lab reports in simple language."
                            },
                            {
                                "role": "user",
                                "content": f"The medical report contains the following text:\n{text}\n\nUser question: {user_query}"
                            }
                        ]
                    )
